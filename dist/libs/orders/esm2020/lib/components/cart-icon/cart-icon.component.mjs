...
CartIconComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CartIconComponent, selectors: [["orders-cart-icon"]], decls: 3, vars: 1, consts: [[2, "position", "relative"], ["pBadge", "", "severity", "danger", 1, "pi", "p-text-secondary", 2, "font-size", "5vw", "position", "absolute", "right", "0", "top", "10%", 3, "value"], ["src", "assets/Carrello mobile.svg", "alt", "Carrello", "routerLink", "/cart", 1, "img-fluid", "p-0", 2, "min-width", "35px"]], template: function CartIconComponent_Template(rf, ctx) { if (rf & 1) {
