...
import * as i1 from "./components/products-search/products-search.component";
import * as i2 from "./components/categories-banner/categories-banner.component";
import * as i3 from "./components/product-item/product-item.component";
import * as i4 from "./components/featured-products/featured-products.component";
import * as i5 from "./pages/products-list/products-list.component";
import * as i6 from "./pages/product-page/product-page.component";
import * as i7 from "./pages/products-brands/products-brands.component";
import * as i8 from "./pages/carousel-products-brands/carousel-products-brands.component";
