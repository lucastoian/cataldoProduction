...
export declare class ProductPageComponent implements OnInit, OnDestroy {
    ...
    brandLogoBlob: any;
    private cart;
    constructor(prodService: ProductsService, route: ActivatedRoute, router: Router, cartService: CartService, variantService: VariantsService, messageService: MessageService, titleService: Title, metaService: Meta);
