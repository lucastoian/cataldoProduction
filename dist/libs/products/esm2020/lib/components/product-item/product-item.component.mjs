...
ProductItemComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ProductItemComponent, selectors: [["eshop-frontend-product-item"]], inputs: { product: "product", appBackImg: "appBackImg" }, decls: 18, vars: 15, consts: [[1, "container-fluid", "p-0", "mb-2", 2, "max-width", "fit-content", "height", "360px", "background-color", "#7e7e7e1a"], [1, "grid", "m-0", "productCard", 2, "justify-content", "center", "height", "329.94px"], [1, "row", 2, "width", "140px", "min-height", "190px"], [1, "col-12", 2, "background-size", "cover", "background-repeat", "no-repeat", "background-color", "#8282823a", "background-blend-mode", "multiply", "background-position-y", "center", 3, "routerLink", "ngStyle"], [1, "row"], [1, "col-auto", 2, "height", "60px", "overflow-y", "auto"], [1, "col-12", "pb-0", "mb-0"], [1, "mb-0", 2, "font-weight", "900"], ["class", "col-12", "style", "text-decoration:  line-through; font-weight: 100; color: rgb(98, 98, 98);", 4, "ngIf"], ["class", "col-12", "style", "min-height: 39.99px;", 4, "ngIf"], [1, "row", "w-100", "p-0", 2, "background-color", "white"], [1, "col-12", "w-100", "p-0", 2, "display", "flex", "align-items", "self-end"], ["type", "button", 1, "btn", "btn-outline-dark", "w-100", "position-relative"], ["class", "position-absolute start-96 translate-middle badge rounded-pill bg-danger", 4, "ngIf"], [1, "col-12", 2, "text-decoration", "line-through", "font-weight", "100", "color", "rgb(98, 98, 98)"], [1, "col-12", 2, "min-height", "39.99px"], [1, "position-absolute", "start-96", "translate-middle", "badge", "rounded-pill", "bg-danger"], [1, "visually-hidden"]], template: function ProductItemComponent_Template(rf, ctx) { if (rf & 1) {
