...
GalleryComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: GalleryComponent, selectors: [["ui-gallery"]], inputs: { product: "product", image: "image", images: "images" }, decls: 5, vars: 2, consts: [[1, "gallery"], [1, "main-image", "pb-2"], ["alt", "", 3, "src"], [1, "images", "d-flex", "flex-row", 2, "height", "20vw", "overflow", "auto"], ["onmouseover", "this.style.backgroundColor='#682e42'", "onmouseout", "this.style.backgroundColor=''", "class", "img-fluid p-1", "alt", "Responsive image", 3, "src", "click", 4, "ngFor", "ngForOf"], ["onmouseover", "this.style.backgroundColor='#682e42'", "onmouseout", "this.style.backgroundColor=''", "alt", "Responsive image", 1, "img-fluid", "p-1", 3, "src", "click"]], template: function GalleryComponent_Template(rf, ctx) { if (rf & 1) {
